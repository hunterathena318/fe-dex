...
import { CurrencyAmount, Token, Trade } from '@techchainswapfinance/sdk'
    ...
    >
      ...
      >
        ...
        <Flex flexDirection="column" alignItems="center">
            ...
            <StyledInputCurrencyWrapper>
              <AppBody>
                ...
                <Wrapper id="limit-order-page" style={{ minHeight: '412px' }}>
                  <AutoColumn gap="sm">
                    <CurrencyInputPanel
                      label={independentField === Field.OUTPUT ? t('Pay') : t('Pay')}
                    ...
                    <CurrencyInputPanel
                      ...
                      label={independentField === Field.INPUT ? t('Receive (Estimated)') : t('Receive')}
                      showMaxButton={false}
                  ...
                  <Box mt="0.25rem">
                    {!account ? (
                      ...
                      >
                        {approvalSubmitted
                          ? t('Enabling %asset%', { asset: currencies.input?.getSymbol(chainId) })
                          : t('Enable %asset%', { asset: currencies.input?.getSymbol(chainId) })}
                      </Button>
                    ) : (
                      <Button
                        variant="linear"
                  ...
                  <Flex mt="16px" justifyContent="center">
                    <Link external href="https://www.gelato.network/">
                      <img
                        src="/images/powered_by_gelato_white.svg"
                        alt="Powered by GALETO"
                        width="142px"
                        height="24px"
                      />
                    </Link>
          ...
          {isMobile && (
            <Flex mt="24px" width="100%" p="0 10px">
