  ...
  return (
    <ModalInner mb="0">
      <Text as="p" mb="24px" fontSize="14px" color="textSubtle">
        {t(
          'Your voting power is determined by the amount of GENI you held at the block detailed below. GENI held in other places does not contribute to your voting power.',
        )}
      </Text>
      ...
      <Text color="secondary" textTransform="uppercase" mb="4px" bold fontSize="14px">
        {t('Your GENI held at block')}
        <StyledLinkExternal href={getEtherscanLink(block, 'block', chainId)} ml="8px">
          {block}
        </StyledLinkExternal>
      </Text>
