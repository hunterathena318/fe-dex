...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        GENI up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active Gemuni Exchange profile can commit. However the maximum amount of
        GENI user can commit, is equal to the average GENI balance in the IFO GENI pool prior to the IFO. And there’s a
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active Gemuni Exchange Profile in order to participate.</Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The GENI from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of GENI to either sale.</Trans>,
      <Trans>
