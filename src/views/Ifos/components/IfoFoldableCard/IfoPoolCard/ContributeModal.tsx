...
const ContributeModal: React.FC<Props> = ({
  ...
  const label = currency === tokens.cake ? t('Max. GENI entry') : t('Max. token entry')
      ...
      <ModalBody maxWidth="360px">
        ...
        <Box p="2px">
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough GENI, you may not receive any IFO tokens at all and will only receive a full refund of your GENI.',
            )}
            <Link
              fontSize="12px"
              display="inline"
