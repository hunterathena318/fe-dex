...
const SwapModalFooterContainer = styled(AutoColumn)`
  ...
  background-color: ${({ theme }) => theme.colors.backgroundTotal};
`
    ...
    <>
            ...
            <QuestionHelper
              text={
                <WrapText>
                  ...
                  <Text>- {t('%amount% towards GENI buyback and burn', { amount: '0.05%' })}</Text>
                </WrapText>
              }
              ml="4px"
            />
      ...
      <AutoRow>
        <Button
          ...
          onClick={onConfirm}
          style={{ background: 'linear-gradient(90deg, #06D3E6 -0.15%, #FFDB0D 96.99%)', marginTop: '30px' }}
