            ...
            <StyledInputCurrencyWrapper mt={isChartExpanded ? '24px' : '0'}>
              <AppBody>
                ...
                <Wrapper id="swap-page" style={{ minHeight: '412px' }}>
                  <AutoColumn gap="sm">
                    <CurrencyInputPanel
                      label={independentField === Field.OUTPUT && !showWrap && trade ? t('From (estimated)') : t('Pay')}
                    ...
                    <AutoColumn justify="space-between">
                      <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ padding: '1rem 1rem' }}>
                        <SwitchIconButton
                          variant="light"
                          scale="sm"
                          onClick={() => {
                    ...
                    {showWrap ? null : (
                      <CustomAutoColumn gap="7px">
                        ...
                        <RowBetween align="center">
                          <WrapText color="textSubtle" fontSize="14px">
                            {t('Slippage Tolerance')}
                            {/* <img src="images/swap/question-help.png" alt="Order" /> */}
                          </WrapText>
                          <CustomText fontSize="14px">{allowedSlippage / 100}%</CustomText>
                        </RowBetween>
                      </CustomAutoColumn>
                    )}
                  </AutoColumn>
                  <Box mt="0.25rem">
                    {swapIsUnsupported ? (
                      <Button width="100%" disabled style={{ fontSize: '16px' }}>
                        {t('Unsupported Asset')}
                      </Button>
                    ) : !account ? (
                      ...
                      <RowBetween>
                        <Button
                          variant={approval === ApprovalState.APPROVED ? 'success' : 'linear'}
                        ...
                        >
                          {approval === ApprovalState.PENDING ? (
                            ...
                            t('Enable %asset%', { asset: currencies[Field.INPUT]?.getSymbol(chainId) ?? '' })
                          )}
                        </Button>
                        <Button
                          style={{ fontSize: '16px' }}
                          variant={isValid && priceImpactSeverity > 2 ? 'danger' : 'linear'}
                          onClick={() => {
                            if (isExpertMode) {
                              handleSwap()
                            } else {
                      ...
                      <Button
                        style={{ fontSize: '16px' }}
                        variant={isValid && priceImpactSeverity > 2 && !swapCallbackError ? 'danger' : 'linear'}
                        onClick={() => {
                          if (isExpertMode) {
                            handleSwap()
                          } else {
