        ...
        <Flex display="inline-flex">
          {accountPath && (
            <IconButton
              ...
              href={getEtherscanLink(accountPath, 'address', chainId) || ''}
              // @ts-ignore
              alt={t('View Explorer for user address')}
            >
    ...
    return (
      <Flex flexDirection="column" mb={[16, null, 0]} mr={[0, null, 16]}>
        {accountPath && profile?.username && (
          <Link href={getEtherscanLink(accountPath, 'address', chainId)} external bold color="primary">
