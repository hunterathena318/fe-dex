  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on Gemuni Exchange.'),
      ],
    },
    {
      ...
      description: [
        t(
          'Soon! The current NFT Market is a basic version (phase 1), with early access to trading Gemuni Exchange NFTs only.',
        ),
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by Gemuni Exchange from sales are used to buy back and BURN GENI tokens in our weekly GENI burns.',
        ),
        t(
          'Platform fees: 2% is subtracted from NFT sales on the market. Subject to change.Collection fees: Additional fees may be taken by collection creators, once those collections are live. These will not contribute to the GENI burns.',
        ),
      ],
    },
  ]
