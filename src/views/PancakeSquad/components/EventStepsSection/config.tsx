  ...
  return [
    {
      ...
      bodyText: [
        t('You’ll need an active Gemuni Exchange Profile to buy Minting Tickets and mint a Pancake Squad NFT!'),
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold GENI'),
      bodyText: [t('Each NFT costs GENI to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
