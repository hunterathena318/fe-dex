...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in GENI prizes this round', { cakePrizeInUsd: cakePriceBusd.toString() })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with GENI, win GENI if your numbers match')}
        </Text>
      </Flex>
