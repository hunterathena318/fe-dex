...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and GENI pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and GENI pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from GENI pool', data)
  }
