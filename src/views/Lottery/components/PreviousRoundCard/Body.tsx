...
const StyledCardRibbon = styled.div`
  background: linear-gradient(82.15deg, #0054ff 16.13%, #5cef89 93.03%);
  border-radius: 15px;
  margin-top: 11px;
  margin-bottom: 25px;
  width: 127px;
  ...
  text-align: center;
  color: #ffffff;
  text-shadow: 1px 1px 2px #08673f;
  display: flex;
  align-items: center;
  justify-content: center;
`
  ...
  return (
    <StyledCardBody>
      <Grid>
        ...
        >
          <Heading style={{ fontSize: '18px' }}>{t('Winning Number')}</Heading>
          {isLatestRound && <StyledCardRibbon>Lasted</StyledCardRibbon>}
        </Flex>
