...
const StyledCardHeader = styled(CardHeader)`
  z-index: 2;
  background: none;
  border-bottom: 1px ${({ theme }) => theme.colors.cardBorderBlur} solid;
`
...
const AllHistoryCard = () => {
  ...
  }, [chainId, selectedRoundId, currentLotteryId, numRoundsFetched, dispatch])
        ...
        <Box mt="8px">
          {selectedRoundId ? (
            selectedLotteryNodeData?.endTime ? (
              <Text fontSize="14px" style={{ color: '#777E90', marginBottom: '16px' }}>
