...
import { Currency, ETHER, JSBI, TokenAmount } from '@techchainswapfinance/sdk'
            ...
            {currency0 ? (
              <Row>
                ...
                <Text ml="8px" fontSize="16px">
                  {currency0 !== ETHER ? currency0.symbol : currency0.getSymbol(chainId)}
                </Text>
              </Row>
            ) : (
              <Text ml="8px" fontSize="16px">
          ...
          >
            {currency1 ? (
              <Row>
                ...
                <Text ml="8px" fontSize="16px">
                  {currency1 !== ETHER ? currency1.symbol : currency1.getSymbol(chainId)}
                </Text>
              </Row>
            ) : (
              <Text as={Row} fontSize="16px">
                {t('Select a Token')}
              </Text>
            )}
          </StyledButton>
            ...
            pairState === PairState.EXISTS ? (
              hasPosition && pair ? (
                <>
                  ...
                  <Button as={NextLinkFromReactRouter} to="/pool" variant="linear" width="100%">
                    {t('Manage this pool')}
                  </Button>
                </>
              ) : (
