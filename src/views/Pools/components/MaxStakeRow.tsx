  ...
  return (
    <Flex flexDirection="column">
      <Flex justifyContent="space-between" alignItems="center">
        ...
        <Text small={small}>{`${getFullDisplayBalance(stakingLimit, stakingToken.decimals, 0)} ${stakingToken.getSymbol(
          chainId,
        )}`}</Text>
      </Flex>
      {hasPoolStarted && (
        <Flex justifyContent="space-between" alignItems="center">
          ...
          <Link external href={getEtherscanLink(stakingLimitEndBlock, 'countdown', chainId)}>
            <Balance
              small={small}
