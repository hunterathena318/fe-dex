...
import { Currency, CurrencyAmount, currencyEquals, ETHER, Token } from '@techchainswapfinance/sdk'
...
function CurrencyRow({
  ...
  return (
    ...
    >
      ...
      <Column>
        <Text bold>{currency !== ETHER ? currency.symbol : currency.getSymbol(chainId)}</Text>
