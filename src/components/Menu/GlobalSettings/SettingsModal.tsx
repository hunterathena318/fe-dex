...
import { CustomText } from 'views/Swap'
...
import getThemeValue from '../../../../packages/uikit/src/util/getThemeValue'
...
const SettingsModal: React.FC<InjectedModalProps> = ({ onDismiss }) => {
  ...
  return (
    <Modal
      title={t('Settings')}
      background={getThemeValue('colors.backgroundModal')(theme)}
    ...
    >
      <ScrollableContainer>
        ...
        <Flex flexDirection="column" borderTop="">
          <CustomText bold textTransform="uppercase" fontSize="12px" color="secondary" mb="24px" fontFamily="Inter">
            {t('Swaps & Liquidity')}
          </CustomText>
          <TransactionSettings />
        </Flex>
        <Flex justifyContent="space-between" alignItems="center" mb="24px">
          <Flex alignItems="center">
            <Text color="grey" fontFamily="Inter" fontSize="16px">
              {t('Expert Mode')}
            </Text>
            <QuestionHelper
