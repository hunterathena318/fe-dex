...
import { CurrencyAmount, Price, Token, TokenAmount, JSBI, ETHER } from '@techchainswapfinance/sdk'
...
export default function useGasOverhead(
  ...
  const inputIsBNB = inputAmount?.currency?.getSymbol(chainId) === ETHER.getSymbol(chainId)
