...
const useFetchedTokenDatas = (tokenAddresses: string[]): TokenDatas => {
  ...
  const [t24h, t48h, t7d, t14d] = getDeltaTimestamps(chainId)
  ...
  }, [block24h, block48h, block7d, block14d, chainId, tokenAddresses])
  ...
  }, [tokenAddresses, block24h, block48h, block7d, block14d, blockError, fetch])
  ...
  //     fetch()
  //   }
  // }, [chainId, block24h, block48h, block7d, block14d, fetch])
