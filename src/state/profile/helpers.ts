...
export const getProfile = async (address: string, chainId: number): Promise<GetProfileResponse> => {
  try {
    ...
    const profileCallsResult = await multicallv2(chainId, profileABI, profileCalls, { requireSuccess: false })
