...
export const useFetchLottery = (nextTime?: any) => {
  ...
  }, [dispatch, currentLotteryId, chainId, nextTime])
  ...
  }, [dispatch, currentLotteryId, account, chainId, nextTime])
}
