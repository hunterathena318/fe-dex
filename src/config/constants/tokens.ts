...
export const mainnetTokens = defineTokens({
  ...
  bnb: new Token(BSC, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'BNB', 'BNB', 'https://www.binance.com/'),
  cake: new Token(
    BSC,
  ...
  geni: new Token(BSC, '0xc04a23149efdF9A63697f3Eb60705147e9f07FfD', 18, 'GENI', 'GemUni', 'https://www.gemuni.io/'),
  tlos: new Token(BSC, '0xb6C53431608E626AC81a9776ac3e999c5556717c', 18, 'TLOS', 'Telos', 'https://www.telos.net/'),
  beta: new Token(
    BSC,
  ...
  nft: new Token(BSC, '0x1fC9004eC7E5722891f5f38baE7678efCB11d34D', 6, 'NFT', 'APENFT', 'https://apenft.org'),
  stephero: new Token(
    BSC,
  ...
  pros: new Token(BSC, '0xEd8c8Aa8299C10f067496BB66f8cC7Fb338A3405', 18, 'PROS', 'Prosper', 'https://prosper.so/'),
  qbt: new Token(BSC, '0x17B7163cf1Dbd286E262ddc68b553D899B93f526', 18, 'QBT', 'Qubit Token', 'https://qbt.fi/'),
  cvp: new Token(
    BSC,
  ...
  usdt: new Token(BSC, '0x55d398326f99059fF775485246999027B3197955', 18, 'USDT', 'Tether USD', 'https://tether.to/'),
  btcb: new Token(BSC, '0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c', 18, 'BTCB', 'Binance BTC', 'https://bitcoin.org/'),
  ust: new Token(
    BSC,
  ...
  kalm: new Token(BSC, '0x4BA0057f784858a48fe351445C672FF2a3d43515', 18, 'KALM', 'Kalmar Token', 'https://kalmar.io/'),
  dkt: new Token(
    BSC,
  ...
  belt: new Token(BSC, '0xE0e514c71282b6f4e823703a39374Cf58dc3eA4f', 18, 'BELT', 'Belt Token', 'https://beta.belt.fi/'),
  watch: new Token(
    BSC,
  ...
  bry: new Token(BSC, '0xf859Bf77cBe8699013d6Dbc7C2b926Aaf307F830', 18, 'BRY', 'Berry Token', 'https://berrydata.co/'),
  wsote: new Token(
    BSC,
  ...
  pha: new Token(BSC, '0x0112e557d400474717056C4e6D40eDD846F38351', 18, 'PHA', 'Phala Token', 'https://phala.network'),
  babycake: new Token(
    BSC,
  ...
  mask: new Token(BSC, '0x2eD9a5C8C13b93955103B9a7C167B67Ef4d568a3', 18, 'MASK', 'Mask Token', 'https://mask.io/'),
  dvi: new Token(
    BSC,
  ...
  txl: new Token(BSC, '0x1FFD0b47127fdd4097E54521C9E2c7f0D66AafC5', 18, 'TXL', 'Tixl Token', 'https://tixl.org/'),
  orbs: new Token(BSC, '0xeBd49b26169e1b52c04cFd19FCf289405dF55F80', 18, 'ORBS', 'Orbs Token', 'https://www.orbs.com/'),
  cos: new Token(
    BSC,
  ...
  nuls: new Token(BSC, '0x8CD6e29d3686d24d3C2018CEe54621eA0f89313B', 8, 'NULS', 'Nuls Token', 'https://www.nuls.io/'),
  ramp: new Token(
    BSC,
  ...
  bfi: new Token(BSC, '0x81859801b01764D4f0Fa5E64729f5a6C3b91435b', 18, 'BFI', 'bearn.fi Token', 'https://bearn.fi/'),
  dexe: new Token(BSC, '0x039cB485212f996A9DBb85A9a75d898F94d38dA6', 18, 'DEXE', 'DeXe Token', 'https://dexe.network/'),
  bel: new Token(
    BSC,
  ...
  dodo: new Token(BSC, '0x67ee3Cb086F8a16f34beE3ca72FAD36F7Db929e2', 18, 'DODO', 'Dodo Token', 'https://dodoex.io/'),
  swingby: new Token(
    BSC,
  ...
  swg: new Token(BSC, '0xe792f64C582698b8572AAF765bDC426AC3aEfb6B', 18, 'SWG', 'SWG Token', 'https://swirgepay.com/'),
  sfp: new Token(
    BSC,
  ...
  bdo: new Token(BSC, '0x190b589cf9Fb8DDEabBFeae36a813FFb2A702454', 18, 'BDO', 'Bdollar Token', 'https://bdollar.fi/'),
  egld: new Token(BSC, '0xbF7c81FFF98BbE61B40Ed186e4AfD6DDd01337fe', 18, 'EGLD', 'Elrond Token', 'https://elrond.com/'),
  front: new Token(
    BSC,
  ...
  bscx: new Token(BSC, '0x5Ac52EE5b2a633895292Ff6d8A89bB9190451587', 18, 'BSCX', 'BSCX Token', 'https://bscex.org/'),
  balbt: new Token(
    BSC,
  ...
  og: new Token(BSC, '0xf05E45aD22150677a017Fbd94b84fBB63dc9b44c', 2, 'OG', 'OG Nice Token', 'https://www.chiliz.com'),
  reef: new Token(
    BSC,
  ...
  hard: new Token(BSC, '0xf79037F6f6bE66832DE4E7516be52826BC3cBcc4', 6, 'HARD', 'HARD Token', 'https://hard.kava.io'),
  broobee: new Token(
    BSC,
  ...
  sxp: new Token(BSC, '0x47BEAd2563dCBf3bF2c9407fEa4dC236fAbA485A', 18, 'SXP', 'Swipe Token', 'https://swipe.io/'),
  alpha: new Token(
    BSC,
  ...
  xvs: new Token(BSC, '0xcF6BB5389c92Bdda8a3747Ddb454cB7a64626C63', 18, 'XVS', 'Venus Token', 'https://venus.io/'),
  sushi: new Token(
    BSC,
  ...
  pnt: new Token(BSC, '0xdaacB0Ab6Fb34d24E8a67BfA14BF4D95D4C7aF92', 18, 'PNT', 'pNetwork Token', 'https://ptokens.io/'),
  mir: new Token(
    BSC,
  ...
  oddz: new Token(BSC, '0xCD40F2670CF58720b694968698A5514e924F742d', 18, 'ODDZ', 'Oddz Token', 'https://oddz.fi/'),
  hoo: new Token(BSC, '0xE1d1F66215998786110Ba0102ef558b22224C016', 8, 'HOO', 'Hoo Token', 'https://hoo.com/'),
  apys: new Token(
    BSC,
  ...
  perl: new Token(BSC, '0x0F9E4D49f25de22c2202aF916B681FBB3790497B', 18, 'PERL', 'Perlin', 'https://perlinx.finance/'),
  alpa: new Token(
    BSC,
  ...
  trx: new Token(BSC, '0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B', 18, 'TRX', 'TRON Token', 'https://tron.network/'),
  win: new Token(BSC, '0xaeF0d72a118ce24feE3cD1d43d383897D05B4e99', 18, 'WIN', 'WIN Token', 'https://winklink.org/'),
  mcoin: new Token(
    BSC,
  ...
  hyfi: new Token(BSC, '0x9a319b959e33369C5eaA494a770117eE3e585318', 18, 'HYFI', 'HYFI Token', 'https://hyfi.pro/#/'),
  oin: new Token(
    BSC,
  ...
  ubxt: new Token(BSC, '0xBbEB90cFb6FAFa1F69AA130B7341089AbeEF5811', 18, 'UBXT', 'UpBots Token', 'https://upbots.com/'),
  wmass: new Token(
    BSC,
  ...
  xend: new Token(BSC, '0x4a080377f83D669D7bB83B3184a8A5E61B500608', 18, 'XEND', 'XEND Token', 'https://xend.finance/'),
  cyc: new Token(BSC, '0x810EE35443639348aDbbC467b33310d2AB43c168', 18, 'CYC', 'CYC Token', 'https://cyclone.xyz/'),
  chr: new Token(BSC, '0xf9CeC8d50f6c8ad3Fb6dcCEC577e05aA32B224FE', 6, 'CHR', 'Chroma Token', 'https://chromia.com/'),
  deri: new Token(
    BSC,
  ...
  ktn: new Token(BSC, '0xDAe6c2A48BFAA66b43815c5548b10800919c993E', 18, 'KTN', 'Kattana Token', 'https://kattana.io/'),
  qkc: new Token(
    BSC,
  ...
  mx: new Token(BSC, '0x9F882567A62a5560d147d64871776EeA72Df41D3', 18, 'MX', 'MX Token', 'https://www.mxc.com/'),
  ata: new Token(
    BSC,
  ...
  o3: new Token(BSC, '0xEe9801669C6138E84bD50dEB500827b776777d28', 18, 'O3', 'O3 Swap Token', 'https://o3swap.com/'),
  hai: new Token(BSC, '0xaA9E582e5751d703F85912903bacADdFed26484C', 8, 'HAI', 'Hacken Token', 'https://hacken.io/'),
  htb: new Token(
    BSC,
  ...
  c98: new Token(BSC, '0xaEC945e04baF28b135Fa7c640f624f8D90F1C3a6', 18, 'c98', 'Coin98 Token', 'https://coin98.com/'),
  pots: new Token(
    BSC,
  ...
  naos: new Token(BSC, '0x758d08864fB6cCE3062667225ca10b8F00496cc2', 18, 'NAOS', 'NAOSToken', 'https://naos.finance/'),
  cart: new Token(
    BSC,
  ...
  mcb: new Token(BSC, '0x5fE80d2CD054645b9419657d3d10d26391780A7B', 18, 'MCB', 'MCDEX', 'https://mcdex.io/homepage/'),
  lazio: new Token(
    BSC,
  ...
  arv: new Token(BSC, '0x6679eB24F59dFe111864AEc72B443d1Da666B360', 8, 'ARV', 'ARIVA', 'https://ariva.digital'),
  moni: new Token(
    BSC,
  ...
  xwg: new Token(BSC, '0x6b23C89196DeB721e6Fd9726E6C76E4810a464bc', 18, 'XWG', 'X World Games', 'https://xwg.games/'),
  eternal: new Token(
    BSC,
  ...
  qi: new Token(BSC, '0x8729438EB15e2C8B576fCc6AeCdA6A148776C0F5', 18, 'QI', 'BENQI', 'https://benqi.fi/'),
  sheesha: new Token(
    BSC,
  ...
  nabox: new Token(BSC, '0x755f34709E369D37C6Fa52808aE84A32007d1155', 18, 'NABOX', 'Nabox Token', 'https://nabox.io/'),
  xcv: new Token(BSC, '0x4be63a9b26EE89b9a3a13fd0aA1D0b2427C135f8', 18, 'XCV', 'XCarnival', 'https://xcarnival.fi/'),
  idia: new Token(
    BSC,
  ...
  htd: new Token(BSC, '0x5E2689412Fae5c29BD575fbe1d5C1CD1e0622A8f', 18, 'HTD', 'HeroesTD', 'https://heroestd.io/'),
  dpt: new Token(
    BSC,
  ...
  antex: new Token(BSC, '0xCA1aCAB14e85F30996aC83c64fF93Ded7586977C', 8, 'ANTEX', 'Antex', 'https://antex.org/'),
  bbt: new Token(
    BSC,
  ...
  gm: new Token(BSC, '0xe2604C9561D490624AA35e156e65e590eB749519', 18, 'GM', 'GoldMiner', 'https://goldminer.games/'),
  aog: new Token(BSC, '0x40C8225329Bd3e28A043B029E0D07a5344d2C27C', 18, 'AOG', 'AgeOfGods', 'https://ageofgods.net/'),
  '8pay': new Token(
    BSC,
  ...
  fuse: new Token(BSC, '0x5857c96DaE9cF8511B08Cb07f85753C472D36Ea3', 18, 'FUSE', 'Fuse Token', 'https://fuse.io/'),
  ertha: new Token(BSC, '0x62823659d09F9F9D2222058878f89437425eB261', 18, 'ERTHA', 'Ertha Token', 'https://ertha.io/'),
  raca: new Token(
    BSC,
  ...
  btt: new Token(BSC, '0x352Cb5E19b12FC216548a2677bD0fce83BaE434B', 18, 'BTT', 'BitTorrent', 'https://bittorrent.com/'),
  era: new Token(BSC, '0x6f9F0c4ad9Af7EbD61Ac5A1D4e0F2227F7B0E5f9', 18, 'ERA', 'Era Token', 'https://www.era7.io/'),
  fight: new Token(
    BSC,
  ...
  bsw: new Token(BSC, '0x965F527D9159dCe6288a2219DB51fc6Eef120dD1', 18, 'BSW', 'Biswap', 'https://biswap.org/'),
} as const)
...
export const testnetTokens = defineTokens({
  ...
  cake: new Token(
    BSC_TESTNET,
    '0xE4437CA913F475B1c9Ef3BE1C078E0b0Cc634d67',
    18,
    'GENI',
    'Gemuni Exchange Token',
    'https://pancakeswap.finance/',
  ),
  busd: new Token(
    BSC_TESTNET,
