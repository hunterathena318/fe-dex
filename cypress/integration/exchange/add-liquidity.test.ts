describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'GENI')
  ...
  it('loads the BNB and tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokenb #pair').should('contain.text', 'GENI')
  })
  ...
  it('does not crash if address is duplicated', () => {
    ...
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'GENI')
    cy.get('#add-liquidity-input-tokenb #pair').should('not.contain.text', 'GENI')
  })
